...
import MessagesList from '../../../src/components/ChatRoomScreen/MessagesList';
...
describe('MessagesList', () => {
    ...
    //     expect(getByTestId(message1, 'message-date')).toHaveTextContent('19:00');

    //     expect(getByTestId(message2, 'message-content')).toHaveTextContent('bar');
    //     expect(getByTestId(message2, 'message-date')).toHaveTextContent('19:00');
    // });
});